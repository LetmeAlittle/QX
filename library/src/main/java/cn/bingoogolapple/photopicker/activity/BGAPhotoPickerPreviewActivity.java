...
public class BGAPhotoPickerPreviewActivity extends BGAPPToolbarActivity implements PhotoViewAttacher.OnViewTapListener {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mContentHvp = (BGAHackyViewPager) findViewById(R.id.hvp_photo_picker_preview_content);
        mChooseRl = (RelativeLayout) findViewById(R.id.rl_photo_picker_preview_choose);
        mChooseTv = (TextView) findViewById(R.id.tv_photo_picker_preview_choose);
    }
