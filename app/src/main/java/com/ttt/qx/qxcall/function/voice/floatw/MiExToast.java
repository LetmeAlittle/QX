...
/**
 * Created by seeker on 2017/2/11.
 */

public class MiExToast implements OnTouchListener {
    ...
    public MiExToast(Context context){
        ...
        mView = inflate.inflate(R.layout.layout_window, null);
    ...
    public void show(){
        if (isShow) return;
        TextView tv = (TextView)mView.findViewById(R.id.percentTv);
//        tv.setText("悬浮窗");
