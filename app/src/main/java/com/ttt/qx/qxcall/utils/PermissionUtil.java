...
/**
 * 安android 6.0以上动态权限管理科
 * Created by wyd on 2017/7/31.
 */

public class PermissionUtil {
    public static final String TAG = "NamePermission";
    ...
    public static final int CODE_WRITE_CALENDAR = 9;
    public static final int CODE_BODY_SENSORS = 10;
    public static final int CODE_SEND_SMSAGE = 11;
    ...
    public PermissionUtil(Activity activity, Context context) {
