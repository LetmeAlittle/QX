...
public class AVChatAudio implements View.OnClickListener, ToggleListener {
    ...
    private LinearLayout avchat_audio_time_ll;
    ...
    private View hangup;
    private View avchat_audio_shouqi;
    private TextView gold_num_tv;

    private View refuse_receive;
    //    private TextView refuseTV;
    private ImageView call;
    private ImageView hand_up;
...
//                receiveTV.setText(R.string.avchat_receive);
    ...
    private void findViews() {
        ...
        avchat_audio_time_ll = (LinearLayout) rootView.findViewById(R.id.avchat_audio_time_ll);
        avchat_audio_shouqi = rootView.findViewById(R.id.avchat_audio_shouqi);
        //当前金币数
        gold_num_tv = (TextView) rootView.findViewById(R.id.gold_num_tv);
        ...
        HomeModel.getHomeModel().getUserInfo(new Subscriber<UserDetailInfo>() {
            ...
            public void onNext(UserDetailInfo userDetailInfo) {
                if (userDetailInfo.getStatus_code() == 200) {
                    gold_num_tv.setText(String.valueOf(userDetailInfo.getData().getMember_account()));
                }
            }
        }, "", authorization);
        ...
        View avchat_gift_present_rl = mute_speaker_hangup.findViewById(R.id.avchat_gift_present_rl);
        avchat_gift_present_rl.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        avchat_audio_shouqi.setOnClickListener(this);
...
//        refuseTV = (TextView) refuse_receive.findViewById(R.id.refuse);
        hand_up = (ImageView) refuse_receive.findViewById(R.id.hand_up);
//        receiveTV = (TextView) refuse_receive.findViewById(R.id.receive);
        call = (ImageView) refuse_receive.findViewById(R.id.call);
        hand_up.setOnClickListener(this);
        call.setOnClickListener(this);

        recordView = rootView.findViewById(R.id.avchat_record);
    ...
    public void showNetworkCondition(int grade) {
        if (grade >= 0 && grade < NETWORK_GRADE_DRAWABLE.length) {
            ...
            netUnstableTV.setVisibility(View.INVISIBLE);
        }
    }
    ...
    private void setSwitchVideo(boolean visible) {
        switchVideo.setVisibility(visible ? View.VISIBLE : View.INVISIBLE);
    ...
    private void setTime(boolean visible) {
        ...
        avchat_audio_time_ll.setVisibility(visible ? View.VISIBLE : View.GONE);
        if (visible) {
