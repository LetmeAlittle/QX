...
public class DeviceUtil {
    ...
    public static float getDensityDpi(Context context) {
        if (displayDensity == 0.0)
            displayDensity = getDisplayMetrics(context).densityDpi;
        return displayDensity;
    }
     ...
     * @return
     */
    public static int getScreenPixDensity(Context context) {
     ...
     * @return
     */
    public static int getScreenPixDensityDpi(Context context) {
