...
public class InfiniteLoopViewPagerAdapter extends LoopBasePagerAdapter {
	private static final String TAG = "InfiniteLoopViewPagerAdapter";
	private static final boolean DEBUG = false;
	private LoopBasePagerAdapter adapter;

	public InfiniteLoopViewPagerAdapter(LoopBasePagerAdapter adapter) {
		super();
