...
public class RetrofitTools {
     ...
     * @return
     */
    public static Observable<GetGuShiResponse> updateDouzi(Map<String, String> map) {
        return subscribe(RetrofitTools.getManager().updateDou(map));
    }
     ...
     * @return
     */
    public static Observable<ShouFeiResponse> getShouFeiList(Map<String, String> map) {
