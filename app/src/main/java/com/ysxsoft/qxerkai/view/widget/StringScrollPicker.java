...
public class StringScrollPicker extends ScrollPickerView<CharSequence> {
    ...
    private int mMinTextSize = 6; // 最小的字体
    private int mMaxTextSize = 16; // 最大的字体
    // 字体渐变颜色
    private int mStartColor = Color.parseColor("#fc5772"); // 中间选中ｉｔｅｍ的颜色
    private int mEndColor = Color.parseColor("#cccccc"); // 上下两边的颜色

    private int mMaxLineWidth = -1; // 最大的行宽,默认为itemWidth.超过后文字自动换行
    private Layout.Alignment mAlignment = Layout.Alignment.ALIGN_NORMAL; // 对齐方式,默认居中
