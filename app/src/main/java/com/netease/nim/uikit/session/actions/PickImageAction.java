...
public abstract class PickImageAction extends BaseAction {
    ...
    private final ImageActionType imageActionType;
    ...
    protected PickImageAction(int iconResId, int titleId, boolean multiSelect, ImageActionType imageActionType) {
...
//            case PHOTO:
//                requestCode = RequestCode.PICK_IMAGE;
//                break;
//            case CAMERA:
//                requestCode = RequestCode.PREVIEW_IMAGE_FROM_CAMERA;
//                break;
//        }
//        makeRequestCode()
        showSelector(getTitleId(), makeRequestCode(requestCode), multiSelect, tempFile());
    }
    ...
    private void showSelector(int titleId, final int requestCode, final boolean multiSelect, final String outPath) {
        ...
        PickImageHelper.pickImage2(getActivity(), requestCode, option,imageActionType);
