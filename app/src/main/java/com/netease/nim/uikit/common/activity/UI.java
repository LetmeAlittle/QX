...
//        toolbar.setLogo(logoId);
    ...
    public void setTitle(CharSequence title) {
        ...
        if (toolbar != null) {
            ...
            ((TextView) findViewById(R.id.user_account_tv)).setText(title);
            findViewById(R.id.top_back_rl).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    DeviceUtil.hideSoftKeyboard(view.getContext(), view);
                    finish();
                }
            });
        }
