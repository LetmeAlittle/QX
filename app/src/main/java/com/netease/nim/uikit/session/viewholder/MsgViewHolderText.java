...
public class MsgViewHolderText extends MsgViewHolderBase {
    ...
    protected void bindContentView() {
        ...
        bodyTextView.setTextColor(isReceivedMessage()
                ?context.getResources().getColor(R.color._363636)
                :context.getResources().getColor(R.color._ffffff));
    ...
    private void layoutDirection() {
        ...
        if (isReceivedMessage()) {
            ...
            bodyTextView.setPadding(ScreenUtil.dip2px(10), ScreenUtil.dip2px(5), ScreenUtil.dip2px(8), ScreenUtil.dip2px(5));
        } else {
            bodyTextView.setBackgroundResource(R.drawable.nim_message_item_right_selector);
            bodyTextView.setPadding(ScreenUtil.dip2px(8), ScreenUtil.dip2px(5), ScreenUtil.dip2px(10), ScreenUtil.dip2px(5));
        }
    }
